...
uint32_t MatrexUtils::getRows(const cl::Buffer &buffer, OCLInterface &ocl)
{
    uint32_t rows;
...
uint32_t MatrexUtils::getCols(const cl::Buffer &buffer, OCLInterface &ocl)
{
    uint32_t cols;
...
void MatrexUtils::setRows(cl::Buffer &buffer, uint32_t rows, OCLInterface &ocl)
{
...
void MatrexUtils::setCols(cl::Buffer &buffer, uint32_t cols, OCLInterface &ocl)
{
...
uint32_t MatrexUtils::getLength(const cl::Buffer &buffer, OCLInterface &ocl)
{
