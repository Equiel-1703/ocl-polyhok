defmodule OCLPolyHok do
  ...
  defmacro phok({:fn, aa, [{:->, bb , [para,body]}] }) do
    ...
    #IO.inspect function
    #raise "hell"
    #{fname,type} = OCLPolyHok.CudaBackend.gen_lambda("Elixir.App",function)
    #result = quote do: OCLPolyHok.load_lambda_compilation(unquote("Elixir.App"), unquote(fname), unquote(type))
    #result
    #IO.inspect result
    #raise "hell"
...
#defmacro gpu_for({:<-, _ ,[var,tensor]},do: b)  do
#    quote do: OCLPolyHok.new_gnx(unquote(tensor))
#              |> PMap.map(OCLPolyHok.phok (fn (unquote(var)) -> (unquote b) end))
#              |> OCLPolyHok.get_gnx
#end
...
def load_fun(fun) do
  case Macro.escape(fun) do
    ...
    _ -> raise "OCLPolyHok.invalid function"
  end
end
