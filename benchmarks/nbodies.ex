...
OCLPolyHok.defmodule NBodies do
  ...
  def map_2_para_no_resp(d_array,  par1, par2, size, f) do
    ...
    nBlocks = floor ((size + block_size - 1) / block_size)
      ...
      OCLPolyHok.spawn(&NBodies.map_step_2_para_no_resp_kernel/6,{nBlocks,1,1},{block_size,1,1},[d_array,step,par1,par2,size,f])
      d_array
  end
...
#h_buf = OCLPolyHok.new_nx_from_function(nBodies,size_body,{:f,32},fn -> 1 end )
